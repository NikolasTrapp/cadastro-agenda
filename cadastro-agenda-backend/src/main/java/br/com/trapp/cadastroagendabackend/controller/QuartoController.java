...
public class QuartoController {
    ...
    @GetMapping("/buscarQuartos")
    public ResponseEntity<List<QuartoProjecao>> buscarHospedes(@RequestParam(name = "numeroQuarto") Long numeroQuarto) {
        return ResponseEntity.status(HttpStatus.OK).body(quartoService.buscarQuartos(numeroQuarto));
    }
}
